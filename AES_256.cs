...
namespace IS_LAB3
{
    class AES_256
    {
        static int nb = 4;  // number of coloumn of State (for AES = 4)
        static int nr = 14; // number of rounds ib ciper cycle (if nb = 4 nr = 10)
        static int nk = 8;  // the key length (in 32-bit words)
